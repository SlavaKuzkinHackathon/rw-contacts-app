          ...
          {data.map((contact) => (
            <TableRow key={contact.login.uuid}>
              ...
              <TableCell>
                ...
                <Typography>{contact.dob.age} years</Typography></TableCell>
              <TableCell><CopyToClipboardText text={contact.email} /></TableCell>
              <TableCell>
                <CopyToClipboardText text={contact.phone} /></TableCell>
              <TableCell>
                <Typography>{contact.location.country}</Typography>
                <Typography>{contact.location.city}, {contact.location.street.name}{" "}
                  {contact.location.street.number}{" "}
                </Typography>
              </TableCell>
              <TableCell align="right">{NATIONALITIES_HUMEN_NAME[contact.nat]}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
